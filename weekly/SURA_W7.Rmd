...
## Visualization
```{r}
# How to add markers of different shapes?
mapview(aqs, zcol ="Date", label=FALSE, legend = TRUE, layer.name = 'Date', 
        popup = popupTable(
                aqs,
                zcol = c(
                  "Date",
...
mapview(rep_pts_sf, zcol = "date", label=FALSE, legend=FALSE, layer.name="Date",
        popup = popupTable(
              rep_pts_sf,
              zcol = c(
                "date",
