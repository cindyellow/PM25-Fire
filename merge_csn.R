...
zz <- file("error_log_csn_merge.Rout", open="wt")
...
aqs.dir = '/home/huan1766/remoteproject/PM25-Research/Data/CSN Data/'
...
aqs <- read.delim(paste0(aqs.dir, "CSN_PM25_SPEC_2000_2021_Cali.csv"), sep=",", strip.white=TRUE)
# aqs <- aqs %>%
...
readLines("error_log_csn_merge.Rout")