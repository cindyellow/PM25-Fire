...
zz <- file("error_log_aqs_csn_merge.Rout", open="wt")
...
remote.aqs.dir = '/home/huan1766/remoteproject/PM25-Research/Data/AQS-CSN Merging/'
...
aqs <- read.delim(paste(aqs.dir, "AQS_CSN_Data_2000_2021.csv"), sep=",", strip.white=TRUE)
# aqs <- aqs %>%
...
readLines("error_log_aqs_csn_merge.Rout")